 ...
 WifiHelper wifi;
  ...
  wifiPhy.SetPcapDataLinkType (YansWifiPhyHelper::DLT_IEEE802_11_RADIO);
   ...
   WifiMacHelper wifiMac;
     ...
     Ssid ssid = Ssid ("Nerwork");
      wifiMac.SetType ("ns3::StaWifiMac",
                       "Ssid", SsidValue (ssid));


  backboneDevices = wifi.Install (wifiPhy, wifiMac,backboneNodes);
  ...
  wifiPhy.EnablePcap ("wifi-topology", apDevices[0]);
  wifiPhy.EnablePcap ("wifi-topology", apDevices[1]);

  if (writeMobility)
    {
      AsciiTraceHelper ascii;
      MobilityHelper::EnableAsciiAll (ascii.CreateFileStream ("wifi-topolgy.mob"));
    }
